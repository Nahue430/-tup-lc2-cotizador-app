...
emailjs.init("FvqR4qjWO8l-LMAU_"); // Reemplaza con tu USER_ID de EmailJS
...
form.addEventListener("submit", function (event) {
  ...
  const serviceID = "service_2d2zfvr"; // Reemplaza con tu SERVICE_ID de EmailJS
  const templateID = "template_n00d04t"; // Reemplaza con tu TEMPLATE_ID de EmailJS
